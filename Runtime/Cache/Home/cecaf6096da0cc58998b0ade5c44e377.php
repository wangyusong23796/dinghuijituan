...
<div class="relationship">
	<ul class="relationship_box">
        ...
        <li class="relationship_1"><a href="#">关于我们</a></li>
        <li class="relationship_2">-</li>
 ...
 <div class="content_right">
      ...
      <div class="news">
        	<dl class="Details1">
            	<dt class=""><?php echo ($info["title"]); ?></dt>
                <dd class="Details1dd2"><?php echo (date('Y-m-d H:i',$info["create_time"])); ?></dd>
                <dd class="Details1dd1"><?php echo (get_username($info["uid"])); ?></dd>
            </dl>
            <div class="Details2">
