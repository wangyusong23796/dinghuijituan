...
<body>
    ...
    <form action="<?php echo U('User/submitNickname');?>" method="post" class="form-horizontal" autocomplete="off">
		...
		<div class="form-item">
			...
			<div class="controls">
				<input type="text" name="nickname" class="text " autocomplete="off" value="<?php echo get_username();?>"/>
			</div>
		</div>
		<div class="form-item">
	...
	<script src="/dinghui/Public/static/thinkbox/jquery.thinkbox.js"></script>
