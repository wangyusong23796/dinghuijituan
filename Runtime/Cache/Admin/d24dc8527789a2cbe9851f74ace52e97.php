...
<body>
	...
	<div class="tab-wrap">
		<div class="tab-content">
			<!-- 表单 -->
			<form id="form" action="<?php echo U('generate');?>" method="post" class="form-horizontal doc-modal-form">
				<!-- 基础 -->
...
<script type="text/javascript" src="/dinghui/Public/static/jquery.dragsort-0.5.1.min.js"></script>
